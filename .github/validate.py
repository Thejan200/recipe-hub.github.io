...
approved_categories = ["Breakfast", "Dinner", "Beef", "Pork", "Seafood", "Soup", "Dessert", "Healthy", "Chicken", "Vegetarian", "USA", "UK", "Canada", "Christmas", "New Year"]
assert isinstance(category_images, dict), "data/category-images.json must contain an object"
assert set(category_images) == set(approved_categories), "Category image registry must contain exactly the 15 approved categories"
