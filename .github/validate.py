...
effective_image_overrides = {
    ...
    "breakfast-tacos": "https://commons.wikimedia.org/wiki/Special:Redirect/file/BreakfastTaco.jpg"
}
...
approved_categories = ["Breakfast", "Dinner", "Beef", "Pork", "Seafood", "Soup", "Dessert", "Healthy", "Chicken", "Vegetarian", "USA"]
